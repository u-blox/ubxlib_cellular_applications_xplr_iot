...
call git clone --recursive -q https://github.com/u-blox/ubxlib_cellular_applications_xplr_iot
cd ubxlib_examples_xplr_iot
call python do -n %ENV_DIR%\ncs -t %ENV_DIR%\%GCCName% save
call :SilentCom "takeown /r /f %ROOT_DIR%\ubxlib_cellular_applications_xplr_iot"
